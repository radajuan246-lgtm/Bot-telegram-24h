...
// 📋 COMANDOS GENERALES
bot.command('start', ctx => ctx.reply('👋 Bienvenido. Escribe /lista para ver todos los productos'));
bot.command('lista', ctx => ctx.reply(Object.values(PRODUCTOS).join('\n\n')));
...
// ✅ COMANDOS NUEVOS: /aceptar y /denegado
